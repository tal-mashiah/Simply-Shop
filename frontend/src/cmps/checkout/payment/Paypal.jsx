...
export default function Paypal({ addOrder, totalPayment }) {
    ...
    let total = totalPayment; // same as above, this is the total amount (based on currency) to be paid by using Paypal express checkout
